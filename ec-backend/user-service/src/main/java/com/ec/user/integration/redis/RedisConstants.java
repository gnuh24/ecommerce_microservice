...
public class RedisConstants {
	...
	public static final String OTP_VERIFY_ACCOUNT = "otp:verify_account"; // dùng kèm với :<email>
	
	// 3. OTP quên mật khẩu
	public static final String OTP_FORGOT_PASSWORD = "otp:forgot_password"; // dùng kèm với :<email>
